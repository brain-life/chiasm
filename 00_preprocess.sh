...
for i in ${list[@]:0:3}; do General_preprocessing $i & done
wait
for i in ${list[@]:3:6}; do General_preprocessing $i & done
wait
for i in ${list[@]:6:9}; do General_preprocessing $i & done
wait
for i in ${list[@]:9:12}; do General_preprocessing $i & done
wait
for i in ${list[@]:12:15}; do General_preprocessing $i & done
wait
for i in ${list[@]:15:18}; do General_preprocessing $i & done
wait
for i in ${list[@]:18:21}; do General_preprocessing $i & done
wait
for i in ${list[@]:21:24}; do General_preprocessing $i & done
wait
for i in ${list[@]:24:27}; do General_preprocessing $i & done
wait
for i in ${list[@]:27:30}; do General_preprocessing $i & done
wait
for i in ${list[@]:30:33}; do General_preprocessing $i & done
wait
