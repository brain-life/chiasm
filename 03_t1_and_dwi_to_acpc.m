...
for i=5:size(subjects,1)
    ...
    dwi=strcat('/home/auguser2016/dMRI_DATA/PREPROCESSED_DATA/0.75mm_iso/',id,'/',id,'_clean_075mm.nii.gz')
    %dwi=strcat('/media/auguser2016/Volume/Test/lw37.nii.gz')
    
    % Bvecs and bvals obtained from corrected DW images
    bvecs=strcat('/home/auguser2016/dMRI_DATA/PREPROCESSED_DATA/0.75mm_iso/',id,'/',id,'_bvecs.bvecs')
    bvals=strcat('/home/auguser2016/dMRI_DATA/PREPROCESSED_DATA/0.75mm_iso/',id,'/',id,'_bvals.bvals')
